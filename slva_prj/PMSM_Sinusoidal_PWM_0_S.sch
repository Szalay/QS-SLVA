...
<Properties>
  <View=-357,-68,2178,1166,0.732072,0,0>
  <Grid=10,10,1>
  <DataSet=PMSM_Sinusoidal_PWM_0_S.dat>
  <DataDisplay=PMSM_Sinusoidal_PWM_0_S.dpl>
  <OpenDisplay=0>
  <Script=PMSM_Sinusoidal_PWM.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <Vfile V1 1 470 1050 18 -26 0 1 "sin_i_cd2_50_0.txt" 1 "linear" 0 "yes" 0 "1" 0 "0" 0>
  <Vfile V4 1 660 1050 18 -26 0 1 "sin_i_a_pwm_50_0.txt" 1 "linear" 0 "yes" 0 "1" 0 "0" 0>
  <Vfile V2 1 80 1050 18 -26 0 1 "sin_u_d_50_0.txt" 1 "linear" 0 "yes" 0 "1" 0 "0" 0>
  <Vfile V3 1 280 1050 18 -26 0 1 "sin_i_cd_50_0.txt" 1 "linear" 0 "yes" 0 "1" 0 "0" 0>
  ...
  <Sub PMSM1 1 650 400 -70 -176 0 0 "PMSM.sch" 0 "90" 1 "0.55" 1 "158e-6" 1 "182e-6" 1 "0.125e-6" 1>
  <Sub PMSM2 1 650 780 -70 -176 0 0 "PMSM.sch" 0 "90" 1 "0.55" 1 "158e-6" 1 "182e-6" 1 "0.125e-6" 1>
  ...
  <.TR TR1 1 50 0 0 60 0 0 "lin" 1 "0" 0 "4.2 ms" 1 "168001" 1 "Trapezoidal" 0 "2" 0 "25n" 0 "25n" 1 "150" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "26.85" 0 "1e-3" 0 "1e-6" 0 "1" 0 "CroutLU" 0 "no" 0 "yes" 0 "25n" 1>
</Components>
<Wires>
...
<Diagrams>
  <Rect 975 960 847 191 3 #c0c0c0 1 00 0 0.003175 0.0002 0.004175 0 -0.05 0.01 0.05 1 -1 0.5 1 315 0 225 1 0 0 "" "" "">
  ...
  <Rect 975 301 840 121 3 #c0c0c0 1 00 0 0.0029 5e-05 0.0034 0 1 1 6 1 -1 1 1 315 0 225 1 0 0 "" "" "">
  ...
  <Rect 974 510 841 120 3 #c0c0c0 1 00 1 0.001 0.0002 0.002 1 -6.86239 5 7.21834 1 -1 1 1 315 0 225 1 0 0 "" "" "">
	<"ngspice/tran.i(vias)" #e01b24 2 3 0 0 0>
	<"ngspice/tran.i(vibs)" #33d17a 2 3 0 1 0>
	<"ngspice/tran.i(vics)" #3584e4 2 3 0 2 0>
  </Rect>
  <Rect 975 701 840 121 3 #c0c0c0 1 00 0 0.003175 0.0002 0.004175 1 -7.20477 5 6.91172 1 -1 1 1 315 0 225 1 0 0 "" "" "">
...
<Paintings>
  ...
  <Rectangle 40 560 510 40 #000000 1 1 #c0c0c0 1 1>
  <Text 50 570 11 #000000 0 "Injection with 180° phase shift for approximate even harmonic extraction">
  <Rectangle 40 930 440 40 #000000 1 1 #c0c0c0 1 1>
  <Text 50 940 11 #000000 0 "Reading measurement data (th_M = 90˚,  th_E = 180˚, south pole)">
</Paintings>
